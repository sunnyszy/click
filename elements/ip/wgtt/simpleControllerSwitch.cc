...
#include "simpleControllerSwitch.hh"
...
SimpleControllerSwitch::SimpleControllerSwitch()
{
  openlog("SimpleControllerSwitch", LOG_PERROR | LOG_CONS | LOG_NDELAY, 0);
...
int SimpleControllerSwitch::configure(Vector<String> &conf, ErrorHandler *errh)
{
...
void SimpleControllerSwitch::push(int port, Packet *p_in)
{
...
void SimpleControllerSwitch::push_status(Packet *p_in)
{
  ...
  //data packet
  WritablePacket *p_data = Packet::make(1400);
...
CLICK_ENDDECLS
EXPORT_ELEMENT(SimpleControllerSwitch)
ELEMENT_MT_SAFE(SimpleControllerSwitch)
